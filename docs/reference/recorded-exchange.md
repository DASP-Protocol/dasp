# Inspect a recorded command exchange

This reference validates recorded examples. It does not run a server or inject a live connection failure. For the reasons behind the rules, start with the [illustrated walkthrough](../build/walkthrough.md).
