defmodule Jido.Seigyo.Client.WorkspaceSummary do
  @moduledoc "The safe Workspace summary in a Session view."

  @fields Jido.Seigyo.Schema.fields(
            Jido.Seigyo.View.workspace_schema(),
            ~w(id name ownership mode status)a
          )
  ...
  def from_data(data) when is_map(data) do
    with {:ok, data} <- Jido.Seigyo.Client.Value.parse(Jido.Seigyo.View.workspace_schema(), data) do
